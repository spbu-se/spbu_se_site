...
| `code-audit` | Code quality and security audit: secrets, redirects, deprecations, crash safety, file safety, test health, universal-safe transformations, SPbU regulation spot-check — load before PR merge gate or after 5+ source file changes |
