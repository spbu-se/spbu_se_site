...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["internships_id"],
            ["internships.id"],
            name=op.f("fk_internships_tag_internships_id_internships"),
        ),
        sa.ForeignKeyConstraint(
            ["internships_tag_id"],
            ["internship_tag.id"],
            name=op.f("fk_internships_tag_internships_tag_id_internship_tag"),
        ),
        sa.PrimaryKeyConstraint(
            "internships_tag_id", "internships_id", name=op.f("pk_internships_tag")
        ),
    )
