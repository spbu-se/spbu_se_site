...
def upgrade():
    ...
    with op.batch_alter_table("staff", schema=None) as batch_op:
        batch_op.create_unique_constraint(
            batch_op.f("uq_staff_official_email"), ["official_email"]
        )

    with op.batch_alter_table("summer_school", schema=None) as batch_op:
        batch_op.alter_column(
            "project_name", existing_type=sa.VARCHAR(length=1024), nullable=False
        )
        batch_op.alter_column(
            "description", existing_type=sa.VARCHAR(length=2048), nullable=False
        )
        batch_op.alter_column(
            "tech", existing_type=sa.VARCHAR(length=1024), nullable=False
        )
        batch_op.alter_column(
            "advisors", existing_type=sa.VARCHAR(length=1024), nullable=False
        )
        batch_op.alter_column(
            "requirements", existing_type=sa.VARCHAR(length=1024), nullable=False
        )
