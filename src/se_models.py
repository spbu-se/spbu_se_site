...
def init_db():
    ...
    curriculum = [
        ...
        {'year': 2019, 'discipline': 'Компьютерные сети', 'study_year': 3, 'type': 1},
        {'year': 2019, 'discipline': 'Основы противодействия коррупции и экстремизму (онлайн-курс)', 'study_year': 3, 'type': 3},
        {'year': 2019, 'discipline': 'Компьютерная графика', 'study_year': 3, 'type': 1},
        {'year': 2019, 'discipline': 'Обеспечение качества и тестирование программного обеспечения ', 'study_year': 3, 'type': 1},
        {'year': 2019, 'discipline': 'Теория автоматов и формальных языков ', 'study_year': 3, 'type': 1},
        {'year': 2019, 'discipline': 'Базы данных', 'study_year': 3, 'type': 1},
        {'year': 2019, 'discipline': 'Производственная практика', 'study_year': 3, 'type': 1},
        {'year': 2019, 'discipline': 'Трансляция языков программирования', 'study_year': 3, 'type': 1},
        {'year': 2019, 'discipline': 'Иностранный язык', 'study_year': 3, 'type': 3},
        ...
        {'year': 2019, 'discipline': 'Теория графов', 'study_year': 3, 'type': 1},
        {'year': 2019, 'discipline': 'Социально-правовые вопросы программной инженерии', 'study_year': 3, 'type': 3},
        {'year': 2019, 'discipline': 'Проектирование и архитектура программного обеспечения', 'study_year': 3, 'type': 1},
        {'year': 2019, 'discipline': 'Алгоритмы анализа графов (по выбору)', 'study_year': 3, 'type': 1},
        {'year': 2019, 'discipline': 'Операционные системы и реализация языков программирования (по выбору)', 'study_year': 3, 'type': 1},
        ...
        {'year': 2019, 'discipline': 'Преддипломная практика', 'study_year': 4, 'type': 1},
        {'year': 2019, 'discipline': 'Интеллектуальные системы', 'study_year': 4, 'type': 1},
        {'year': 2019, 'discipline': 'Прикладные задачи теории вероятностей', 'study_year': 4, 'type': 2},
        {'year': 2019, 'discipline': 'Защита информации', 'study_year': 4, 'type': 1},
        {'year': 2019, 'discipline': 'Анализ требований к программному обеспечению', 'study_year': 4, 'type': 1},
        {'year': 2019, 'discipline': 'Управление программными проектами', 'study_year': 4, 'type': 1},
        {'year': 2019, 'discipline': 'Иностранный язык', 'study_year': 4, 'type': 3},
        ...
        {'year': 2019, 'discipline': 'Введение в MS.NET (по выбору)', 'study_year': 4, 'type': 1},
        {'year': 2019, 'discipline': 'Современные технологии разработки бизнес-приложений (по выбору)', 'study_year': 4, 'type': 1},
        {'year': 2019, 'discipline': 'Программная инженерия (по выбору)', 'study_year': 4, 'type': 1},
        {'year': 2019, 'discipline': 'Системное программирование для современных платформ (по выбору)', 'study_year': 4, 'type': 1},
        {'year': 2019, 'discipline': 'Основы менеджмента', 'study_year': 4, 'type': 3},
        {'year': 2019, 'discipline': 'Философия (онлайн-курс)', 'study_year': 4, 'type': 3},
        {'year': 2019, 'discipline': 'Практика разработки документации (на английском языке) (по выбору)', 'study_year': 4, 'type': 1},
        {'year': 2019, 'discipline': 'Стохастическая оптимизация в информатике (на английском языке) (по выбору)', 'study_year': 4, 'type': 1},
