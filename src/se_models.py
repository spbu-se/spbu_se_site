...
def init_db():
    ...
    courses = [
        {'name' : 'Математическое обеспечение и администрирование информационных систем', 'code' : '02.03.03'},
        {'name' : 'Программная инженерия', 'code' : '09.03.04'},
        {'name': 'Математическое обеспечение и администрирование информационных систем', 'code': '02.04.03'},
    ]
    tags = [
        {
            'name' : 'Компилятор'
