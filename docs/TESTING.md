...
Reference run (2026-08-14, `pytest --tb=no -q -rxX`): **1288 passed, 4 skipped, 4 xfailed, 8 xpassed**. The intermittent-marker count drifts between runs (flaky XPASS whenever the path passes); re-verify drift is stability, not flakiness, before touching any marker.
