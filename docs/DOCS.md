...
| `MCP.md` | Agent tooling | MCP/CLI-tool selection, decision framework, catalog, security and token rules, config stance | Process, per-tool CLI mechanics | MCP & agent-tool policy |
