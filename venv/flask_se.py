...
def department_staff():
    staff = [
        ...
        {"name": "Немешев Марат Халимович", "position": "Старший преподаватель", "contacts": "m.nemeshev@spbu.ru",
         'avatar': 'empty.jpg'},
        {"name": "Романовский Константин Юрьевич", "position": "Доцент, к.ф.-м.н.", "contacts": "kromanovsky@gmail.com",
         'avatar': 'empty.jpg'},
...
def department_staff2():
    staff = [
        {"name": "Баклановский Максим Викторович", "position": "Старший преподаватель", "contacts": "baklanovsky@gmail.com", 'avatar': 'baklanovsky.jpg'},
        {"name": "Брыксин Тимофей Александрович", "position": "Доцент, к.т.н.", "contacts": "timofey.bryksin@gmail.com",'avatar': 'bryksin.jpg'},
        {"name": "Булычев Дмитрий Юрьевич", "position": "Доцент, к.ф.-м.н.", "contacts": "dboulytchev@gmail.com", 'avatar': 'boulytchev.jpg'},
        {"name": "Граничин Олег Николаевич", "position": "Профессор, д.ф.-м.н.", "contacts": "o.granichin@spbu.ru",'avatar': 'granichin.jpg'},
        {"name": "Журавлев Максим Михайлович", "position": "Старший преподаватель", "contacts": "vecktor.vek@gmail.com",'avatar': 'zhuravlev.jpg'},
        {"name": "Зеленчук Илья Валерьевич", "position": "Старший преподаватель", "contacts": "ilya@hackerdom.ru",'avatar': 'zelenchuk.jpg'},
        {"name": "Кириленко Яков Александрович", "position": "Старший преподаватель", "contacts": "jake.kirilenko@gmail.com",'avatar': 'kirilenko.jpg'},
        {"name": "Козлов Антон Павлович", "position": "Старший преподаватель", "contacts": "drakon.mega@gmail.com",'avatar': 'empty.jpg'},
        {"name": "Кознов Дмитрий Владимирович", "position": "Профессор, д.т.н.", "contacts": "dkoznov@yandex.ru",'avatar': 'koznov.jpg'},
        {"name": "Куликов Егор Константинович", "position": "Старший преподаватель", "contacts": "egor.k.kulikov@gmail.com",'avatar': 'empty.jpg'},
        {"name": "Литвинов Юрий Викторович", "position": "Доцент, к.т.н.", "contacts": "yurii.litvinov@gmail.com", 'avatar': 'litvinov.jpg'},
        {"name": "Лозов Петр Алексеевич", "position": "Инженер исследователь", "contacts": "", 'avatar': 'empty.jpg'},
        {"name": "Луцив Дмитрий Вадимович", "position": "Доцент, к.ф.-м.н.", "contacts": "dluciv@gmail.com", 'avatar': 'luciv.jpg'},
        {"name": "Моисеенко Евгений Александрович", "position": "Инженер исследователь", "contacts": "",'avatar': 'empty.jpg'},
        {"name": "Мордвинов Дмитрий Александрович", "position": "Старший преподаватель", "contacts": "mordvinov.dmitry@gmail.com",'avatar': 'empty.jpg'},
        {"name": "Немешев Марат Халимович", "position": "Старший преподаватель", "contacts": "m.nemeshev@spbu.ru",'avatar': 'empty.jpg'},
        {"name": "Романовский Константин Юрьевич", "position": "Доцент, к.ф.-м.н.", "contacts": "kromanovsky@gmail.com",'avatar': 'empty.jpg'},
        {"name": "Сартасов Станислав Юрьевич", "position": "Старший преподаватель", "contacts": "stanislav.sartasov@gmail.com",'avatar': 'empty.jpg'},
        {"name": "Серов Михаил Александрович", "position": "Доцент", "contacts": "m.serov@spbu.ru",'avatar': 'empty.jpg'},
        {"name": "Смирнов Михаил Николаевич", "position": "Старший преподаватель, к.т.н.", "contacts": "mikhail.smirnov@lanit-tercom.com",'avatar': 'smirnov.jpg'},
        {"name": "Сысоев Сергей Сергеевич", "position": "Доцент, к.ф.-м.н.", "contacts": "sysoev@petroms.ru",'avatar': 'empty.jpg'},
        {"name": "Терехов Андрей Николаевич", "position": "Профессор, д.ф.-м.н., заведующий кафедрой", "contacts": "a.terekhov@spbu.ru",'avatar': 'terekhov.jpg'},
        {"name": "Ханов Артур Рафаэльевич", "position": "Старший преподаватель", "contacts": "awengar@gmail.com",'avatar': 'empty.jpg'},
        {"name": "Шилов Сергей Юрьевич", "position": "Старший преподаватель", "contacts": "serguei.shilov@gmail.com",'avatar': 'empty.jpg'},
    ]
...
def department_staff3():
    ...
    return render_template('department_staff3.html', staff = staff)

@app.route(URL_PREFIX + '/department/staff4.html')
def department_staff4():
    staff = [
        {"name": "Баклановский Максим Викторович", "position": "Старший преподаватель",
         "contacts": "baklanovsky@gmail.com", 'avatar': 'baklanovsky.jpg'},
        {"name": "Брыксин Тимофей Александрович", "position": "Доцент, к.т.н.", "contacts": "timofey.bryksin@gmail.com",
    ...
    return render_template('department_staff4.html', staff = staff)

@app.route(URL_PREFIX + '/department/staff5.html')
def department_staff5():
    staff = [
        {"name": "Баклановский Максим Викторович", "position": "Старший преподаватель",
         "contacts": "baklanovsky@gmail.com", 'avatar': 'baklanovsky.jpg'},
        {"name": "Брыксин Тимофей Александрович", "position": "Доцент, к.т.н.", "contacts": "timofey.bryksin@gmail.com",
    ...
    return render_template('department_staff5.html', staff = staff)
