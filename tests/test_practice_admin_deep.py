        ...
        with patch("flask_se_practice_admin.handle_yandex_table") as mock_handle:
            ...
            resp = client.post(
                ...
                data={
                    ...
                    "table_name": "table.xlsx",
                    "sheet_name": "Sheet1",
                    "user_name_column": "Р¤РРћ",
                    "how_to_contact_column": "РљРѕРЅС‚Р°РєС‚С‹",
                    "supervisor_column": "Р СѓРєРѕРІРѕРґРёС‚РµР»СЊ",
                    "consultant_column": "РљРѕРЅСЃСѓР»СЊС‚Р°РЅС‚",
                    "theme_column": "РўРµРјР°",
                    "text_column": "РўРµРєСЃС‚",
                    "supervisor_review_column": "РћС‚Р·С‹РІ",
                    "reviewer_review_column": "РћС‚Р·С‹РІ СЂРµС†",
                    "code_column": "РљРѕРґ",
                    "committer_column": "РљРѕРјРјРёС‚РµСЂ",
                    "presentation_column": "РџСЂРµР·РµРЅС‚Р°С†РёСЏ",
                },
            )
            assert resp.status_code in (200, 302)
